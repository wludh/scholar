  ...
  def create
    ...
    if @duplicategroup.nil?
      ...
      respond_to do |format|
        ...
        format.html { redirect_to "/scholar" + group_path(@group) }
      end
    else
      respond_to do |format|
        flash[:notice] = t('common.groups.flash_create_duplicate')
        format.html { redirect_to "/scholar" + new_group_path }
      end
    end
  end
  ...
  def hide
    ...
    if children.blank?
      ...
      respond_to do |format|
        ...
        format.html { redirect_to "/scholar" + groups_path() }
      end
    else
      respond_to do |format|
        flash[:error] = t('common.groups.flash_hide_failure_html', :children => child_list(children))
        #format.html { redirect_to :action => "edit" }
        format.html { redirect_to "/scholar" + group_path(@group) + "/edit" }
      end
    end
  end
