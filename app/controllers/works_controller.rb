...
respond_to :js, :json, :html
  ...
  def orphans_delete
    ...
    redirect_to "/scholar" + orphans_works_path(:page => params[:page], :per_page => params[:per_page])
  end
  ...
  def change_type
    ...
    respond_to do |format|
      format.html { redirect_to "/scholar" + edit_work_path(work.id) }
      format.xml { head :ok }
    end
  end
  ...
  def create
    ...
    if params['cancel']
      ...
      respond_to do |format|
        format.html { redirect_to "/scholar" + new_work_path }
        format.xml { head :ok }
      end
    ...
    if params['cancel']
      ...
      respond_to do |format|
        unless return_path.nil?
          format.html { redirect_to "/scholar" + return_path }
        else
  ...
  def destroy
    ...
    work = Work.find(params[:id])
    return_path = params[:return_path] || works_path
