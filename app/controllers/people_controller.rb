...
class PeopleController < ApplicationController
  ...
  make_resourceful do
    ...
    publish :xml, :json, :yaml, :attributes => [
        :id, :name, :first_name, :middle_name, :last_name, :prefix, :suffix, :image_url, :phone, :email, :im, :office_address_line_one, :office_address_line_two, :office_city, :office_state, :office_zip, :research_focus, :active,
    ...
    before :destroy do
      ...
      @return_path = params[:return_path] || "/scholar" + people_path
  ...
  def create
    ...
    if params['cancel']
      ...
      respond_to do |format|
        format.html { redirect_to "/scholar" + new_person_path }
        format.xml { head :ok }
      end
      ...
      if @dupeperson.nil?
        respond_to do |format|
          if @person.save
            ...
            format.html { redirect_to "/scholar" + new_person_pen_name_path(@person.id) }
  ...
  def update
    ...
    if params['cancel']
      #just return back to 'new' page
      respond_to do |format|
        format.html { redirect_to "/scholar" + person_path(@person) }
        format.xml { head :ok }
      end
