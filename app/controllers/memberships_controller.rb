class MembershipsController < ApplicationController
  ...
  def create_multiple
    ...
    return_path = "/scholar" + new_person_membership_path(:person_id=>params[:person_id],
  ...
  def destroy
    ...
    respond_to do |format|
      format.html do
        if @membership
          redirect_to "/scholar" + new_person_membership_path(:person_id => @membership.person.id)
        else
